...
\begin{itemize}
    ...
    \begin{align*}
        World \cong X \rightarrow SemTy \;\;\;\; SemTy \cong [\mathbf{Worlds} , Set]\\
    \end{align*}
...
\end{itemize}
 ...
 A $world : X \rightarrow SynTy$ is a map from a finite set into the set of syntactic types. Morphisms $f : X \rightarrow Y$ 
 ...
 collection of case symbols and the injective map $i$ represents \textit{renaming}.
 \footnote{Formalized 
...
exception that we specify that our \textit{resources} are a specific kind 
