...
It seems this would extend to our \textit{multisorted} scenario\footnote{The Schanuel topos models classical HOL, is this problematic?} \cite{sterlingSyntaxSemanticsAbstract2016}
\cite{gabbayNewApproachAbstract2002}. 
